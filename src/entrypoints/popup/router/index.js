...
const router = createRouter({
	...
	routes: [
        ...
        { path: '/restrictions', name: 'restrictions', component: () => import('../views/Restrictions.vue'), meta: { middlewares: [mustBeConfigured, checkLock], watchedByKicker: true } },
        ...
        { path: '/accounts', name: 'accounts', component: () => import('../views/twofaccounts/Accounts.vue'), meta: { middlewares: [mustBeConfigured, checkLock], watchedByKicker: true }, alias: '/' },
        { path: '/account/create', name: 'createAccount', component: () => import('../views/twofaccounts/CreateUpdate.vue'), meta: { middlewares: [mustBeConfigured, checkLock], watchedByKicker: true } },
