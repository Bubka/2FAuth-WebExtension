const en = {
    message: {
        ...
        docs_how_to_create_a_pat: '2FAuth docs: How to create a PAT',
        ...
        purpose_requirements: 'You must have and bind a 2FAuth user account to the extension to use it. This requires a Personal Access Token (PAT).',
        test: 'Test',
